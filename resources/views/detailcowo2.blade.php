        ...
        <div class="container-fluid page-header mb-5 p-0" style="background-image: url({{asset('assets/img/about.jpg')}});">
            <div class="container-fluid page-header-inner py-5">
                <div class="container text-center pb-5">
                    <h1 class="display-3 text-white mb-3 animated slideInDown">Man Rooms</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item"><a href="#">Pages</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">Man Rooms 2</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-center text-primary text-uppercase">Man Rooms 2</h6>
                    <h1 class="mb-5">Explore Man <span class="text-primary text-uppercase">Rooms 2</span></h1>
                </div>
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <h3>Deskripsi Kamar 2</h3>
                        <p class="text-body mb-3">Tipe kamar ini terdiri dari 3 unit kamar tanpa perabotan (kosongan).</p>
                        <p>Harga dengan tipe ini Rp.5.500.000,00/tahun.</p>
                    </div><br><br><br>
                    <div class="col-md-4 bg-white pt-3">
                          <h2 class="font-weight-bold mb-2">Fasilitas Kamar 2</h2>
                          <ul>
                                <li>Luas kamar (3 x 2,5).</li>
