                ...
                <div class="container text-center pb-5">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">Man Rooms 3</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-center text-primary text-uppercase">Man Rooms 3</h6>
                    <h1 class="mb-5">Explore Man <span class="text-primary text-uppercase">Rooms 3</span></h1>
                </div>
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <p class="text-body mb-3">Tipe kamar ini terdiri dari 8 unit kamar tanpa perabotan (kosongan).</p>
                        <p>Harga dengan tipe ini Rp650.000,00/bulan.</p>
                    </div><br><br><br>
                    <div class="col-md-4 bg-white pt-3">
                          <h2 class="font-weight-bold mb-2">Fasilitas Kamar 3</h2>
                          <ul>
                                <li>Luas kamar (3 x 3).</li>
