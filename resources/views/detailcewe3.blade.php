                ...
                <div class="container text-center pb-5">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page"> Woman Rooms 3</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-center text-primary text-uppercase">Woman Rooms 3</h6>
                    <h1 class="mb-5">Explore Woman <span class="text-primary text-uppercase">Rooms 3</span></h1>
                </div>
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <h3>Deskripsi Kamar 3</h3>
                        <p class="text-body mb-3">Tipe kamar ini terdiri dari 1 unit kamar tanpa perabotan (kosongan). Kamar ini <b>hanya</b> di khususkan untuk orang yang <b>membutuhkan</b></p>
                        <p>Harga dengan tipe ini Rp1.200.000,00/tahun.</p>
                    </div><br><br><br>
                    <div class="col-md-4 bg-white pt-3">
                          <h2 class="font-weight-bold mb-2">Fasilitas Kamar 3</h2>
                          <ul>
                                <li>Luas kamar (3 x 3 M).</li>
                                <li>Kamar mandi luar (Terdapat 2 kamar mandi)</li>
                                <li>Listrik.</li>
                                <li>Jemuran.</li>
                                <li>Lahan Parkir.</li>
                                <li>Sampah.</li>
                    ...
                    <!-- <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="room-item shadow rounded overflow-hidden">
                            ...
                            <div class="p-4 mt-2">
                                ...
                                <div class="d-flex justify-content-between">
                                    <a class="btn btn-sm btn-primary rounded py-2 px-4" href="">View Detail</a>
                                    <a class="btn btn-sm btn-dark rounded py-2 px-4" href="bookingcewe2.html">Book Now</a>
                                </div>
                            </div>
                        </div>
                    </div> -->
                    <!-- <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="room-item shadow rounded overflow-hidden">
                            ...
                            <div class="p-4 mt-2">
                                ...
                                <div class="d-flex justify-content-between">
                                    <a class="btn btn-sm btn-primary rounded py-2 px-4" href="">View Detail</a>
                                    <a class="btn btn-sm btn-dark rounded py-2 px-4" href="bookingcewe3.html">Book Now</a>
                                </div>
                            </div>
                        </div>
                    </div> -->
