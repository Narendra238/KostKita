                            ...
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <div class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu rounded-0 m-0">
                                        ...
                                        <a href="/roomcewe" class="dropdown-item">Laki - laki</a>
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form>
                                <div class="row g-2">
                                    ...
                                    <div class="col-12">
                                        <div class="form-floating">
                                            <input type="password" class="form-control" id="password" placeholder="Masukkan Konfirmasi Password">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a href="login.html" class="btn btn-primary py-3 px-5 mt-2">Register</a>
