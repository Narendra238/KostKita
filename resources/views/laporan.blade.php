...
<body>
  ...
  <h5 class="fw-bold mb-4">Laporan</h5>
  
  <div class="row align-items-center mt-3">
  <div class="col-md-2">
    <div class="form-check">
      <input class="form-check-input" type="radio" name="laporanOption" id="laporanTahunan">
      <label class="form-check-label" for="laporanTahunan">
        Tahun
      </label>
    </div>
  </div>
  <div class="col-md-4">
    ...
    <!-- Tombol -->
    <button type="submit" class="btn btn-warning mt-3">Tampilkan</button>
  </div>
</div>
