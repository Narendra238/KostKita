                ...
                <div class="container text-center pb-5">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">Kamar Perempuan Large</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Explore Kamar <span class="text-primary text-uppercase">PEREMPUAN LARGE</span></h1>
                </div>
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="room-item shadow rounded overflow-hidden">
                            <div class="position-relative">
                                <img class="img-fluid" src="{{asset('assets/img/cewe1.jpg')}}" alt="">
                                </div>
                            <div class="p-4 mt-2">
                            </div>
                        </div><br>
                        <h3>Kamar Perempuan Ukuran Large</h3>
                        <p class="text-body mb-3">Tipe kamar ini terdiri dari 4 unit kamar tanpa perabotan (kosongan).</p>
                        <p>Harga dengan tipe ini Rp550.000,00/bulan.</p>
                    </div><br><br><br>
                    <div class="col-md-4 bg-white pt-3">
                          <h2 class="font-weight-bold mb-2">Fasilitas</h2>
                          <ul>
                                <li>Luas kamar (3 x 4 M).</li>
